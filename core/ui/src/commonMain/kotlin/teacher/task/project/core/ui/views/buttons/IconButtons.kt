...
//
//@Composable
//fun SecondaryMoreIconButton(onClick: () -> Unit) {
//    SecondaryIconButton(
//        icon = painterResource(id = R.drawable.more_gray),
...
//
//@Composable
//fun MoreIconButtonWithoutBackground(modifier: Modifier = Modifier, onClick: () -> Unit) {
//    IconButtonWithoutBackground(
//        icon = painterResource(id = R.drawable.more_black),
//        contentDescription = stringResource(id = R.string.more),
//        onClick = onClick,
//        size = 32.dp,
//        modifier = modifier,
...
//
//@Composable
//fun PrimaryCheckIconButton(modifier: Modifier = Modifier, onClick: () -> Unit) {
//    IconButtonWithoutBackground(
//        modifier = modifier,
//        icon = painterResource(id = R.drawable.primary_check),
...
//
//@Composable
//fun SecondaryCheckIconButton(modifier: Modifier = Modifier,  enabled: Boolean = false, onClick: () -> Unit) {
//    IconButtonWithoutBackground(
//        modifier = modifier,
//        enabled = enabled,
//        icon = painterResource(id = R.drawable.secondary_check),
//        contentDescription = stringResource(id = R.string.check),
//        onClick = onClick,
//        shape = CircleShape
//    )
...
//
//@Composable
//fun PrimaryCalendarIconButton(modifier: Modifier = Modifier, onClick: () -> Unit) {
//    PrimaryIconButton(
//        modifier = modifier,
//        icon = painterResource(id = R.drawable.calendar_primary),
//        contentDescription = stringResource(id = R.string.calendar2),
//        onClick = onClick,
//        size = 32.dp,
//        shape = RoundedCornerShape(size = 7.dp)
//    )
